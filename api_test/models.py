...
class Robot(models.Model):
    ...
    """
    id = models.AutoField(primary_key=True)
    nickName = models.CharField(max_length=128, blank=True, null=True, verbose_name="用户名")
    role_type = models.CharField(max_length=128, blank=True, null=True, verbose_name="角色类型")
    robotType = models.CharField(max_length=50, blank=True, null=True, verbose_name="机器人类型")
    name = models.CharField(max_length=128, blank=True, null=True, verbose_name="收信人")
...
class RobotInfo(models.Model):
    ...
    """
    id = models.AutoField(primary_key=True)
    robotType = models.ForeignKey(Robot, on_delete=models.CASCADE, verbose_name="机器人")
    info = models.CharField(max_length=1024, blank=True, null=True, verbose_name="信息")
