# Generated by Django 2.0.1 on 2018-02-06 09:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apiGroupLevelFirst', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_test.ApiGroupLevelFirst', verbose_name='项目ID')),
            ],
            options={
                'verbose_name': '接口二级分组',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('response', models.CharField(blank=True, max_length=1024, null=True, verbose_name='返回数据')),
                ('mock_code', models.CharField(blank=True, choices=[('200', '200'), ('404', '404'), ('400', '400'), ('502', '502'), ('500', '500'), ('302', '302')], max_length=50, null=True, verbose_name='HTTP状态')),
                ('data', models.TextField(blank=True, max_length=1024, null=True, verbose_name='内容')),
                ...
                ('apiGroupLevelFirst', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ApiGroupLevelFirst_id', to='api_test.ApiGroupLevelFirst', verbose_name='所属一级分组')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apiInfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_test.ApiInfo', verbose_name='接口ID')),
            ],
            options={
                'verbose_name': '接口操作历史',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('examineType', models.CharField(choices=[('no_check', '不校验'), ('only_check_status', '校验http状态'), ('json', 'JSON校验'), ('entirely_check', '完全校验'), ('Regular_check', '正则校验')], max_length=50, verbose_name='校验方式')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationGroupLevelFirst', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_test.AutomationGroupLevelFirst', verbose_name='一级分组ID')),
            ],
            options={
                'verbose_name': '用例二级分组',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_test.AutomationCaseApi', verbose_name='接口ID')),
            ],
            options={
                'verbose_name': '请求头',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationGroupLevelSecond', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api_test.AutomationGroupLevelSecond', verbose_name='所属用例二级组')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_type', models.CharField(choices=[('POST', 'POST'), ('GET', 'GET'), ('PUT', 'PUT'), ('DELETE', 'DELETE')], max_length=1024, verbose_name='请求方式')),
                ...
                ('status_code', models.CharField(choices=[('200', '200'), ('404', '404'), ('400', '400'), ('502', '502'), ('500', '500'), ('302', '302')], max_length=1024, verbose_name='期望HTTP状态')),
                ('examineType', models.CharField(choices=[('no_check', '不校验'), ('only_check_status', '校验http状态'), ('json', 'JSON校验'), ('entirely_check', '完全校验'), ('Regular_check', '正则校验')], max_length=1024, verbose_name='匹配规则')),
                ...
                ('http_status', models.CharField(blank=True, choices=[('200', '200'), ('404', '404'), ('400', '400'), ('502', '502'), ('500', '500'), ('302', '302')], max_length=50, null=True, verbose_name='http状态')),
                ...
                ('automationCaseApi', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api_test.AutomationCaseApi', verbose_name='接口ID')),
            ],
            options={
                'verbose_name': '测试结果',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=1024, null=True, verbose_name='描述')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Project', to='api_test.Project', verbose_name='项目ID')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='User', to=settings.AUTH_USER_MODEL, verbose_name='操作人')),
            ],
            options={
                'verbose_name': '项目动态',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_test.Project', verbose_name='项目ID')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='UserInfo', to=settings.AUTH_USER_MODEL, verbose_name='用户ID')),
            ],
            options={
                'verbose_name': '项目成员',
        ...
        migrations.AddField(
            model_name='automationtesttask',
            name='automationTestCase',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api_test.AutomationTestCase', verbose_name='用例ID'),
        ),
        migrations.AddField(
