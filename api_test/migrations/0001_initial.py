    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.TextField(blank=True, max_length=1024, null=True, verbose_name='mock内容')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=1024, null=True, verbose_name='描述')),
                ('api', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_test.ApiInfo', verbose_name='所属接口')),
            ],
            options={
                'verbose_name': '请求参数',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api_test.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
                'verbose_name': '测试结果',
        ...
        migrations.AddField(
            model_name='apihead',
            name='api',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_test.ApiInfo', verbose_name='所属接口'),
        ),
        migrations.AddField(
