# Generated by Django 2.0.1 on 2018-01-31 09:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_head', models.CharField(blank=True, max_length=1024, null=True, verbose_name='请求头')),
                ...
                ('requestParameter', models.CharField(blank=True, max_length=1024, null=True, verbose_name='请求参数')),
        ...
        migrations.AddField(
            model_name='automationtesttask',
            name='automationTestCase',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_test.AutomationTestCase', verbose_name='接口ID'),
        ),
        migrations.AddField(
