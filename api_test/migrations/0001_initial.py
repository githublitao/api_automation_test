# Generated by Django 2.0.2 on 2018-06-28 10:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('host', models.CharField(blank=True, max_length=50, null=True, verbose_name='访客地址')),
                ('callTime', models.DateField(auto_now_add=True, verbose_name='访问时间')),
            ],
            options={
                'verbose_name': '访客',
